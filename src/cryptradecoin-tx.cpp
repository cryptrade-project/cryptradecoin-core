...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CryptradeCoin Core cryptradecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cryptradecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptradecoin transaction") + "\n" +
                               "  cryptradecoin-tx [options] -create [commands]   " + _("Create hex-encoded cryptradecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptradecoin transaction
