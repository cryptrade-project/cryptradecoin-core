...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CryptradeCoin Core"),
     ...
     * override -datadir in the cryptradecoin.conf file in the default data directory
     * (to be consistent with cryptradecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
