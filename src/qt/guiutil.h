...
/** Utility functions used by the CryptradeCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render CryptradeCoin addresses in monospace font
...
// Parse "cryptradecoin:" URI into recipient object, return true on successful parsing
