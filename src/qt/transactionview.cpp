                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received CRCO from zCRCO"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCRCO"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zCRCO));
