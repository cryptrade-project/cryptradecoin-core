                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CryptradeCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CryptradeCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cryptradecoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCRCO"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CryptradeCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about CryptradeCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CryptradeCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CryptradeCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CryptradeCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a CryptradeCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CryptradeCoin Core help message to get a list with possible CryptradeCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CryptradeCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CryptradeCoin network", "", count));
}
...
{
    QString strTitle = tr("CryptradeCoin Core"); // default title
