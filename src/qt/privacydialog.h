...
public:
    ...
    void setZCrcoControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzCRCO_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzCRCO_clicked();
    void on_pushButtonZCrcoControl_clicked();
