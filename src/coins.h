...
/** 
    ...
    ****Note - for CryptradeCoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of cryptradecoin coming in to a transaction
