...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CryptradeCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "CryptradeCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CryptradeCoin features */
        {"cryptradecoin", "masternode", &masternode, true, true, false},
        {"cryptradecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"cryptradecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cryptradecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cryptradecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cryptradecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"cryptradecoin", "startmasternode", &startmasternode, true, true, false},
        {"cryptradecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cryptradecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cryptradecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cryptradecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cryptradecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cryptradecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cryptradecoin", "mnbudget", &mnbudget, true, true, false},
        {"cryptradecoin", "preparebudget", &preparebudget, true, true, false},
        {"cryptradecoin", "submitbudget", &submitbudget, true, true, false},
        {"cryptradecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cryptradecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cryptradecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cryptradecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cryptradecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cryptradecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cryptradecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cryptradecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"cryptradecoin", "mnsync", &mnsync, true, true, false},
        {"cryptradecoin", "spork", &spork, true, true, false},
        {"cryptradecoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cryptradecoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cryptradecoind, or the -server option to cryptradecoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cryptradecoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15601/\n";
}
