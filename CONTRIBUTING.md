Contributing to CryptradeCoin Core
============================

The CryptradeCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CryptradeCoin Core project, and is not to be
confused with overall CryptradeCoin Network Protocol consensus changes.

Whether a pull request is merged into CryptradeCoin Core rests with the project merge
...
Patches that change CryptradeCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the CryptradeCoin consensus, it must have been
...
The project leader is the release manager for each CryptradeCoin Core release.
