...
In order to support loading of multiple wallets in cryptradecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cryptradecoin.cpp.
...
Changes to cryptradecoin.cpp
----------------------
cryptradecoin.cpp is the entry point into cryptradecoin-qt, and as such, will require some minor modifications to provide hooks for
